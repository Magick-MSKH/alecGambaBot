...
* `!help`           Tells you to join the Discord or check Github for the list of commands
...
## The Spreadsheet with the current point totals for everyone are here (along with other info and stuff):
(https://docs.google.com/spreadsheets/d/1PcfKt4lYn_rA8Kb_VOPBEEm6o-f4sT5HL1NJ-x0MP14/edit?usp=sharing)